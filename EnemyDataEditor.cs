...
public class EnemyDataEditor : OdinMenuEditorWindow
{
    ...
    protected override OdinMenuTree BuildMenuTree()
    {
        ...
        tree.AddAllAssetsAtPath("Enemy Data", "Assets/Scripts/ScriptableObject", typeof(EnemyData));
        return tree;
    }
    ...
    public class CreateNewEnemyData
    {
        ...
        {
            AssetDatabase.CreateAsset(enemyData, "Assets/Scripts/ScriptableObject" + enemyData.enemyName + ".asset");
